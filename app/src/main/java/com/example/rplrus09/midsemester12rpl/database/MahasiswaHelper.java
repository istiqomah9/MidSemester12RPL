...
import static com.example.rplrus09.midsemester12rpl.database.DatabaseContract.MahasiswaColumns.NAMA;
import static com.example.rplrus09.midsemester12rpl.database.DatabaseContract.MahasiswaColumns.NIM;
import static com.example.rplrus09.midsemester12rpl.database.DatabaseContract.MahasiswaColumns.TANGGAL;
import static com.example.rplrus09.midsemester12rpl.database.DatabaseContract.MahasiswaColumns.URL;
import static com.example.rplrus09.midsemester12rpl.database.DatabaseContract.TABLE_NAME;
...
//        dataBaseHelper = new DatabaseHelper(context);
    ...
    public ArrayList<MahasiswaModel> getDataByName(String nama){
        ...
        if (cursor.getCount()>0) {
            do {
                mahasiswaModel = new MahasiswaModel(username, gambar, deskripsi);
